...
ti.targets.msp430.elf.MSP430.rootDir ?= C:/ti/ccsv6/tools/compiler/ti-cgt-msp430_15.12.0.LTS
...
main.xe430: package/cfg/main_pe430.oe430 
	...
	@$(MSG) lnke430 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.msp430.elf.MSP430.rootDir)/bin/lnk430 -w -q -u _c_int00  -q -o $@ package/cfg/main_pe430.oe430   package/cfg/main_pe430.xdl  -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.msp430.elf.MSP430.rootDir)/lib/libc.a
